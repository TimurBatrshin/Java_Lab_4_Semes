...
public class EditAddressHelper extends HelperBase {


    public EditAddressHelper(ApplicationManager manager) {
        super(manager);
    }


    public void editAddress(MyAddress myAddress) {
        driver.findElement(By.xpath("//div[@id='app']/div/div/div/div/div/div[3]/div/div[2]/div/div/div/div[2]/div[2]/div/div/div[3]/div/button")).click();
